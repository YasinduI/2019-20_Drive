...
//Drive Train
        ...
        if (gamepad1.right_stick_button) {
            ...
            FrontRight = (float) Range.clip(FrontRight, -0.7, 0.7);
            FrontLeft = (float) Range.clip(FrontLeft, -0.7, 0.7);
            BackLeft = (float) Range.clip(BackLeft, -0.7, 0.7);
            BackRight = (float) Range.clip(BackRight, -0.7, 0.7);
