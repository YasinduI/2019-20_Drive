...
//         */
//        //Mat lastMat = new Mat(4,4, 1,new Scalar(0, 255, 0));
//        Mat lastMat = new Mat();
//        Mat tempMat = new Mat();
//
//        @Override
...
//             */
////            Mat frameYellow = new Mat();
////            Imgproc.cvtColor(frameYellow, frameYellow, Imgproc.COLOR_BayerRG2GRAY);
//
////            Mat mat = Mat.eye(3, 3, Imgproc. CvType.CV_8UC1);
...
//
//            Mat img = imread("/aa_skystone_block.jpg");
//
//            Mat hsv = input.clone();
//            Imgproc.cvtColor(input, hsv, Imgproc.COLOR_BGR2HSV);
////            input.inRange(hsv, lowerBlue, upperBlue, hsv); //hsv
//
//            input.copyTo(lastMat);
//            double result = 0;
//            try {
//                result = Imgproc.compareHist(input, lastMat, 2);
//            } catch (Exception e) {
//                e.printStackTrace();
//            }
//
////            if (true){
////                telemetry.addData("Keystore found!", "1");
////            } else {
////                telemetry.addData("Keystore found!", "2");
////            }
//
//            DetectColor detectColor = new DetectColor();
//            tempMat = detectColor.processImage(input);
//
//            telemetry.addData("Keystore found>>>>>>>>>>>>>>!", result);
////            telemetry.addData("Keystore found>>>>>>>>>>>>>>!", tempMat.dump());
//            telemetry.addData("Mat value >>>>>>>>>>>>>>>>>> ", tempMat.toString());
//            telemetry.addData("Mat total value >>>>>>>>>>>>>>>>>> ", tempMat.total());
//            telemetry.addData("Mat size value >>>>>>>>>>>>>>>>>> ", tempMat.size().toString());
//            tempMat.
//
////            telemetry.addData("Keystore found!", result);
//            telemetry.update();
...
//
//        org.opencv.core.Size size = new Size(5,5);
//        Imgproc.blur(srcImg, blurImg, size );
//
